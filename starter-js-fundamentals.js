...
const r = 3.14159
const volume = r * radius**2 * height
...
function kilometersToMiles(DistanceInKilo){
  const miles = DistanceInKilo * 0.621371;
...
function testCylinderVolume() {
  ...
  if (cylinderVolume(2, 5) !== 62.8318) {
    console.error('Test failed: Cylinder with radius 2 and height 5 should have a volume of 62.8318');
  }
  
  // Test 2: A cylinder with radius 4 and height 10 should have a volume of 502.6548
  if (cylinderVolume(4, 10) !== 502.6548) {
    console.error('Test failed: Cylinder with radius 4 and height 10 should have a volume of 502.6548');
  }
  
  // Test 3: A cylinder with radius 1 and height 1 should have a volume of 3.14159
  if (cylinderVolume(1, 1) !== 3.14159) {
    console.error('Test failed: Cylinder with radius 1 and height 1 should have a volume of 3.14159');
  }
